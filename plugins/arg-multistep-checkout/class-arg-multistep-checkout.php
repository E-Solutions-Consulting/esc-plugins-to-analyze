...
class WooCommerceCheckout
{
    ...
    public static function initHooks()
    {
        ...
        //WooCommerce
        add_action('before_woocommerce_init', array('argMC\WooCommerceCheckout', 'declareCompatibility'));        
    ...
    public static function declareCompatibility()
    {
        if ( class_exists( \Automattic\WooCommerce\Utilities\FeaturesUtil::class ) ) {
            \Automattic\WooCommerce\Utilities\FeaturesUtil::declare_compatibility( 'custom_order_tables', 'arg-multistep-checkout/arg-multistep-checkout.php', true );
        }     
    }
