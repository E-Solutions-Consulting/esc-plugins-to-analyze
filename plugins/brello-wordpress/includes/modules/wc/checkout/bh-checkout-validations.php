...
class Bh_Checkout_Validations {
    ...
    function validate_accept_terms(){
        ...
        if(!isset($_POST['bh_accept_checkout_terms']) || $_POST['bh_accept_checkout_terms']!=='on'){
            wc_add_notice(__('You must accept the Checkout Terms & Conditions to continue.', 'woocommerce'), 'error');
        }
    }
