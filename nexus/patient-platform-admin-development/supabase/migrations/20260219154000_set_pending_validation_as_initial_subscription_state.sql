-- Make pending_validation the initial/default lifecycle state for subscriptions.
-- Existing records are left unchanged.

ALTER TABLE IF EXISTS public.subscriptions
  ALTER COLUMN status SET DEFAULT 'pending_validation'::public.subscription_status;
